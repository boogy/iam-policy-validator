...
> Policy 1 (S3 access):
> ```json
> {"Version": "2012-10-17", "Statement": [{"Effect": "Allow", "Action": ["s3:GetObject"], "Resource": "arn:aws:s3:::bucket1/*"}]}
> ```
>
...
> "If I use iam:*User* in my policy, what actions would that actually allow?"
...
>   "Version": "2012-10-17",
>   "Statement": [
>     {"Sid": "ReadAccess", "Effect": "Allow", "Action": "s3:GetObject", "Resource": "*"},
>     {"Sid": "ReadAccess", "Effect": "Allow", "Action": "s3:ListBucket", "Resource": "*"}
>   ]
> }
> ```"
